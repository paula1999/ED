...
/**
  ...
  */
  ...
  /**
  * @brief Devuelve el número de eventos de la Fecha_Historica
  * @return El número de eventos de la Fecha_Historica
  */
  int getEventos() const;

  /**
  * @brief Devuelve el número de eventos reservados de la Fecha_Historica
  * @return El número de eventos de la Fecha_Historica
  */
  int getReservados() const;

  /**
  * @brief Devuelve un string de la Fecha_Historica
  * @param posicion Posición del string que buscamos
  * @return El string de la posicion @a posicion
  */
  string getString(int posicion) const;


  /**
  * @brief Asignarle un año a la Fecha_Historica
  * @param a Año que vamos a asignar
  */
